    ...
    : KXmlGuiWindow(), StartClockRunning(clockrun), StartDateString(startdate)
{
    ...
    QString title = liveStacker ? i18nc("@title:window", "Live Stacker") : i18nc("@title:window", "KStars");
...
const QSharedPointer<FITSViewer> &KStars::genericFITSViewer()
{
    if (m_GenericFITSViewer.isNull())
    {
        ...
        m_GenericFITSViewer.reset(new FITSViewer(Options::independentWindowFITS() ? nullptr : this, FITSViewer::Mode::Full),
                                  &QObject::deleteLater);
        // JEE END TEST
