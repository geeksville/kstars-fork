...
FixedMagnificationOptics::FixedMagnificationOptics(const int id, const QString &model, const double aperture, const double magnification) :
    Optics(id, model, aperture), m_Magnification(magnification)
{ }
