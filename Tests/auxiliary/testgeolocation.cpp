...
void TestGeolocation::testGeolocation_data()
{
}

void TestGeolocation::testGeolocation()
{
    QSKIP("Not implemented yet.");
}

void TestGeolocation::testParseCityDatabase()
{
    QSKIP("Not implemented yet.");
}

void TestGeolocation::testCoordinates()
{
    QSKIP("Not implemented yet.");
}
